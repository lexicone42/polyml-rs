...
val () = print ("@@genprog_sc_132=" ^ (wrap (fn () => Int.toString ((Int.abs (Char.ord (if ((case [(#"x"), (#"w"), (#"v"), (#"i")] of [] => #"?" | c :: _ => c) = (Char.toUpper (#"x"))) then (Char.toLower (Char.toUpper (#"p"))) else (String.sub ((String.map Char.toUpper "hj5y"), 0)))))))) ^ "\n");
