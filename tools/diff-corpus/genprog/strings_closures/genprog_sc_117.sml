...
val () = print ("@@genprog_sc_117=" ^ (wrap (fn () => Char.toString ((Char.chr (Int.abs ((Int.abs ((fn v1 => (case [(~1), (~8), 0] of [] => 0 | x :: _ => x)) (Int.abs (let val adder = (fn a => fn b => a + b) in ((adder (~9)) (~8)) end))))) mod 128))))) ^ "\n");
