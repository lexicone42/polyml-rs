...
val () = print ("@@genprog_sc_143=" ^ (wrap (fn () => sl2s ((List.rev (List.rev (String.fields (fn c => c = #",") (Substring.string (Substring.dropr Char.isSpace (Substring.full ((fn z => String.implode (List.rev (String.explode z))) "5hv05")))))))))) ^ "\n");
