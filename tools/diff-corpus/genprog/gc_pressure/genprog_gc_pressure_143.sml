...
val () = print ("@@genprog_gc_pressure_143=" ^ (wrap (fn () => pr2s ((let val xs = List.tabulate (Int.abs (((Int.abs 10) div (10 - (~5)))) mod 3000 + 1000, fn i => i mod 13) in (List.length xs, List.foldl (fn (a,b) => a + b) 0 xs) end)))) ^ "\n");
