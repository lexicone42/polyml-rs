...
val () = print ("@@genprog_gc_pressure_12=" ^ (wrap (fn () => Int.toString ((case (List.take (List.map (fn x => (x div (Int.min (x, x)))) (List.tabulate (Int.abs ((Int.max (((~7) mod 7), ((~5) div (~7))))) mod 1500 + 500, fn i => i)), 4)) of [] => 0 | [a] => a | (a :: b :: _) => a + b)))) ^ "\n");
