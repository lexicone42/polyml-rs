...
val () = print ("@@genprog_gc_pressure_10=" ^ (wrap (fn () => Bool.toString ((List.null (List.take (List.map (fn x => (Int.abs (Int.abs x))) (List.tabulate (Int.abs ((((~6) - 4) + ((~9) + 10))) mod 1500 + 500, fn i => i)), 4)))))) ^ "\n");
