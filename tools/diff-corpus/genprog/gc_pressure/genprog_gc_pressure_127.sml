...
val () = print ("@@genprog_gc_pressure_127=" ^ (wrap (fn () => Int.toString (((depthTree (mirrorTree (mirrorTree (let val v1 = "weo1u" in (Lf 2) end)))) mod (sumTree (mirrorTree (mirrorTree (Lf (~2))))))))) ^ "\n");
