...
val () = print ("@@genprog_gc_pressure_105=" ^ (wrap (fn () => ((Int.toString (case (List.take (List.rev (List.tabulate (Int.abs ((Int.abs (Int.min (10, (~5))))) mod 2000 + 1000, (fn i => ((Int.min (i, (~1))) div (8 + i))))), 5)) of [] => 0 | [a] => a | (a :: b :: _) => a + b))))) ^ "\n");
