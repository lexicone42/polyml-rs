...
val () = print ("@@genprog_dre_115=" ^ (wrap (fn () => Int.toString ((case (if (List.exists (fn x => x > 0) (case (case [10, 0, (~2)] of [] => [] | _ :: t => t) of [] => [] | _ :: t => t)) then Non else Non) of Non => 0 | Som 0 => 100 | Som n => n)))) ^ "\n");
