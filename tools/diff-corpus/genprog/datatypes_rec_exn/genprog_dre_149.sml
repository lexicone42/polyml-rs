...
val () = print ("@@genprog_dre_149=" ^ (wrap (fn () => pr2s ((let val t = (treeMap (fn x => ((case Non of Som n => n | Non => raise E1 (~1)) handle E1 k => k)) (let val v1 = (Som ((~5) mod 0)) in (Br ((Br ((Leaf 6), (Leaf (~6)))), (listToTree []))) end)) in (treeSum t, treeDepth t) end)))) ^ "\n");
