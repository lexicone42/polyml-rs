...
val () = print ("@@genprog_dre_10=" ^ (wrap (fn () => ((Bool.toString ((treeShow (let val v1 = (((8, 3) handle E2 => ((~2), (~3))) handle E1 v2 => ((~2), 1) | _ => ((~1), (~5))) in (((Leaf (~5)) handle E1 v3 => raise E2) handle E2 => (Leaf (~3)) | _ => (Leaf (~3))) end)) = ((String.map Char.toUpper (let val v4 = [(~2), (~10)] in " 7" end)) handle E1 v5 => (let val v6 = (String.size "de") in (case (Rgt "zag1") of Lft n => "L" ^ Int.toString n | Rgt s => "R" ^ s) end) | _ => (Int.toString (#1 (2, 9))))))))) ^ "\n");
