...
val () = print ("@@genprog_dre_101=" ^ (wrap (fn () => ((Bool.toString ((Int.toString (#1 (let val t = (Leaf 4) in (treeSum t, treeDepth t) end))) = (String.concatWith "-" (List.map Int.toString (List.filter (fn x => x mod 2 = 0) (List.filter (fn x => x mod 2 = 0) [0, 4, (~2)]))))))))) ^ "\n");
