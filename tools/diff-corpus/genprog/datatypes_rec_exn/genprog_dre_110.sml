...
val () = print ("@@genprog_dre_110=" ^ (wrap (fn () => ((case (let val v1 = (Lft ((List.length [(~3)]) * (7 - 9))) in (Som (Int.abs (case v1 of Lft n => n | Rgt s => String.size s))) end) of Non => "none" | Som n => "some:" ^ Int.toString n)))) ^ "\n");
