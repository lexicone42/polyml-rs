...
val () = print ("@@genprog_dre_123=" ^ (wrap (fn () => (case ((Rgt (treeShow ((let val v1 = ("842 " ^ "j7") in (((Leaf (~6)) handle E1 v2 => raise E2) handle E2 => (Leaf (~7)) | _ => (Leaf 8)) end) handle E1 v3 => (Leaf (treeProd (Leaf 3))) | _ => ((treeMap (fn x => (treeDepth (Leaf (~8)))) (Leaf 2)) handle E1 v4 => (Leaf v4) | _ => (listToTree [(~5), 8, (~6), 4])))))) of Lft n => "L" ^ Int.toString n | Rgt s => "R" ^ s))) ^ "\n");
