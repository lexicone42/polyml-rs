...
val () = print ("@@genprog_dre_131=" ^ (wrap (fn () => (case ((let val n = (case (Rgt (Int.toString (let val v1 = [(~9)] in 8 end))) of Lft n => n | Rgt s => String.size s) in if n mod 2 = 0 then Lft n else Rgt (Int.toString n) end)) of Lft n => "L" ^ Int.toString n | Rgt s => "R" ^ s))) ^ "\n");
