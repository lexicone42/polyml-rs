...
if [ "$MODE" = "full" ]; then
  ...
  for t in real_math parsetree_introspect isabelle_pure isabelle_pure_arbint \
           isabelle_kernel isabelle_theorem_kernel isabelle_proving isabelle_object_logic isabelle_arithmetic isabelle_number_theory isabelle_summation isabelle_ordering intflip_basis \
