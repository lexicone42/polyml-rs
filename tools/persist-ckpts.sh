...
ARTIFACTS=(
  ...
  hol4_num hol4_arith hol4_order hol4_prim_rec hol4_relation hol4_arithmetic hol4_numeral hol4_numsimps hol4_pair hol4_sum hol4_one hol4_option hol4_defn hol4_numpair
)
