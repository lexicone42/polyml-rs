...
mod tests {
    ...
    fn base_opcodes_are_distinct() {
        let all = [
            INSTR_JUMP8, INSTR_JUMP8_FALSE, INSTR_LOAD_ML_WORD, INSTR_STORE_ML_WORD,
            INSTR_ALLOC_REF, INSTR_BLOCK_MOVE_WORD, INSTR_LOAD_UNTAGGED, INSTR_STORE_UNTAGGED,
            INSTR_CASE16, INSTR_CALL_CLOSURE, INSTR_RETURN_W, INSTR_STACK_CONTAINER_B,
            INSTR_RAISE_EX, INSTR_LOCAL_W, INSTR_LOCAL_B, INSTR_LOCAL_0, INSTR_LOCAL_1,
            INSTR_LOCAL_2, INSTR_LOCAL_3, INSTR_LOCAL_4, INSTR_LOCAL_5, INSTR_LOCAL_6,
            INSTR_LOCAL_7, INSTR_LOCAL_8, INSTR_LOCAL_9, INSTR_LOCAL_10, INSTR_LOCAL_11,
            ...
            INSTR_CONST_10, INSTR_CONST_INT_B, INSTR_CONST_INT_W,
            INSTR_FIXED_ADD, INSTR_FIXED_SUB, INSTR_FIXED_MULT,
            INSTR_EQUAL_WORD, INSTR_LESS_SIGNED, INSTR_GREATER_SIGNED,
            INSTR_RETURN_B, INSTR_RETURN_1, INSTR_RETURN_2, INSTR_RETURN_3,
            INSTR_NO_OP, INSTR_ESCAPE,
        ];
